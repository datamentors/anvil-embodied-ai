...
from mcap_converter.cli.convert import plan_episode_shards, resolve_parallel_episode_workers
...
def test_resolve_parallel_episode_workers_auto_caps_by_episode_count(monkeypatch):
    monkeypatch.setattr("mcap_converter.cli.convert.os.cpu_count", lambda: 28)
