...
`mcap_convert_gpu.viz.dataset_check.validate_dataset_root`, then either prints
...
from mcap_convert_gpu.viz.config import default_repo_id
from mcap_convert_gpu.viz.dataset_check import validate_dataset_root
...
def parse_episodes_spec(spec: str, total_episodes: int) -> List[int]:
    ...
    `mcap_convert_gpu.cli.convert.parse_episode_index_spec`, but is 0-based to
