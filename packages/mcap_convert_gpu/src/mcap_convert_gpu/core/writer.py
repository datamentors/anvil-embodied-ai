...
class LeRobotWriter:
    ...
    def __init__(
        ...
        Args:
            ...
            streaming_encoding: If True, let LeRobot encode video while frames stream in
            encoder_queue_maxsize: Max buffered frames per camera when streaming encoding
